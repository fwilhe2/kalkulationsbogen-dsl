...
export interface KalkulationsbogenAstType {
    Greeting: Greeting
    Model: Model
    Person: Person
}

export class KalkulationsbogenAstReflection extends AbstractAstReflection {
...
export const reflection = new KalkulationsbogenAstReflection();
